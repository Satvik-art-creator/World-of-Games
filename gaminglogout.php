			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-12">
					<div class="box-shadow">
						...
						<p><span><a href="#" class="anchor"> Click to see more info about it</a></span></p>
						<h1>Pubg Mobile</h1>
						<h2>Bluehole</h2>
					</div>
				</div>
		...
		<div class="row">
			...
			<form action="" method="POST">
					<div class="form-group">
						<input type="text" class="form-control" name="firstName" id="username" pattern="[A-Za-z]{1,}" title="Mention your name properly" required autocomplete="off" placeholder="Enter Your First Name">
					</div>

					<div class="form-group">
						<input type="text" class="form-control" name="lastName" id="username" pattern="[A-Za-z]{1,}" title="Mention your name properly" required autocomplete="off" placeholder="Enter Your Sur Name">
					</div>
...
var preloader = document.getElementById('loading');
	...
	swal({
	title: "Thanks!",
	text: "Hello, Welcome to the BEAST Mode of our Website!",
	icon: "success",
	button: "OK",
});
...
if(isset($_POST['submit'])){
	...
	$insertquery = " insert into contactTable(firstName, lastName, email, mobile, message) values('$firstName', '$lastName', '$email', '$mobile', '$message') ";
	...
	if(ctype_alpha($firstName) && ctype_alpha($lastName)){
		...
		?>
			...
			<script type="text/javascript">
				...
				swal({
					title: "Verification!",
					text: `Hii! ${firstName} Your message has successfully sent!`,
					icon: "success",
					button: "OK",
				}); 
