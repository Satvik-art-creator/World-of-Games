	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/PewDiePie" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel PewDiePie</span></a></p>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/channel/UCoz3Kpu5lv-ALhR4h9bDvcw" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Shroud</span></a></p>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/NinjasHyper" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Ninja</span></a></p>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/miniminter" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Miniminter</span></a></p>
				<p><a href="https://www.youtube.com/user/MM7Games" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel MM7Games</span></a></p>
			</div>	
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/ldshadowlady" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel LDShadowLady</span></a></p>
				<p><a href="https://www.youtube.com/channel/UCo1EeBExY-7dtu3BlikS3Fw" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel More LDShadowLady</span></a></p>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/sam14319" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Dynamo Gaming</span></a></p>
			</div>	
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/channel/UC7Q7pl0z0MrdayvmAnchlJQ" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Mortal</span></a></p>
			</div>	
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/user/AddictedA1" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Carry Minati</span></a></p>
				<p><a href="https://www.youtube.com/channel/UC0IWRLai-BAwci_e9MylNGw" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel CarryisLive</span></a></p>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/channel/UCaA8TUWM6TJ5wj-DH60VEFg" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Ron Gaming</span></a></p>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-12">
				...
				<p><a href="https://www.youtube.com/channel/UCQ-aRbnit-y0TlR7CpNSJWA" style="cursor: pointer;">Click me to see the <span class="font-weight-bold mt-2">Youtube Channel Soul Viper</span></a></p>
			</div>		
